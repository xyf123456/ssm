...
function deleteUser(obj) {
    $.ajax({
        ...
        // http://localhost:8080/ssm/user/deluser/1
        url:"/ssm/user/delUser/"+obj.attr("userid"),
        dataType: "json",
        success: function (data) {
            if (data.delUser === "yes") {//删除成功：移除删除行
                cancleBtn();
                obj.parents("tr").remove();//异步更新页面
               alert("删除成功！");
            } else if (data.delUser === "no") {//删除失败
...
$(function () {
    ...
    $(".viewUser").on("click", function () {
        ...
        // http://localhost:8080/ssm/user/viewUser/1
    ...
    $(".modifyUser").on("click", function () {
        ...
        // http://localhost:8080/ssm/user/usermodify/1
